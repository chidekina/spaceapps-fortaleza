...
const Awards = React.memo(() => {
    return (
        <ul className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-x-4 md:gap-x-6 lg:gap-x-8 gap-y-20 md:gap-y-30 lg:gap-y-50 py-8 md:py-12 lg:py-16 z-20 justify-items-center px-12'>
            {awards.map(award => (
