...
const AboutIntro = () => (
    <div className="pt-24">
        ...
        <SlideFromRight className="absolute right-4 md:right-8 lg:right-15 top-1/2 transform -translate-y-1/2 max-w-xs md:max-w-md lg:max-w-lg text-white z-30 px-4 md:px-0 text-center md:text-left">
            ...
            <p className="text-base md:text-lg lg:text-xl leading-relaxed mb-4 md:mb-5 lg:mb-6 lg:mr-6 text-justify">
            ...
            <p className="text-base md:text-lg lg:text-xl leading-relaxed mr-6 text-justify">
